...
public class SubsequentCallingPoint {
    ...
    @Expose
    private List<CallingPoint_> callingPoint = new ArrayList<CallingPoint_>();
     ...
     *     The callingPoint
     */
    public List<CallingPoint_> getCallingPoint() {
        return callingPoint;
    }
     ...
     *     The callingPoint
     */
    public void setCallingPoint(List<CallingPoint_> callingPoint) {
